...
phase_mock_setup() {
    ...
    # phase_validate.zsh reads TOS_GHOST_LOGIN from config — an App
    # installation token has no user behind it. The mock's gh still answers
    # `api user` for the PAT fallback path.
